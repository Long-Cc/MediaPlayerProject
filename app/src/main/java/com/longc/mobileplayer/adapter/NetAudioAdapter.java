...
public class NetAudioAdapter extends BaseAdapter {
    ...
    private final List<NetAudioData.ListEntity> mDatas;
    ...
    public NetAudioAdapter(Context context, List<NetAudioData.ListEntity> datas) {
    ...
    public int getItemViewType(int position) {
        NetAudioData.ListEntity listEntity = mDatas.get(position);
        int itemViewType = -1;
    ...
    private void bindData(int itemViewType, ViewHolder viewHolder, NetAudioData.ListEntity mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
