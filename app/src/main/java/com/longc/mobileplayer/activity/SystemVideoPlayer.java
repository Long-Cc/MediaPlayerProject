...
import com.longc.mobileplayer.View.VideoView;
...
//    private float startX;
    ...
    private void showSwitchVitamioPlayer() {
        new AlertDialog.Builder(SystemVideoPlayer.this)
                .setTitle("系统播放器提示您：")
                .setMessage("如果出现有声音没图像的时候，可以切换到万能播放器！")
...
//            Toast.makeText(SystemVideoPlayer.this, "出错了！", Toast.LENGTH_SHORT).show();
    ...
    /**
     * 跳转到VitamioVideoPlayer
     * 1.将数据原样传入VitamioVideoPlayer播放器
     * 2.关闭原系统播发器
     */
