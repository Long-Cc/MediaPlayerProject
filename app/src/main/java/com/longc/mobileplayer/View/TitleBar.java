...
import com.longc.mobileplayer.activity.SearchActivity;
...
//                Toast.makeText(context, "搜索", Toast.LENGTH_SHORT).show();
            ...
            case R.id.rl_game://游戏
                Toast.makeText(context, "游戏--尚未开发", Toast.LENGTH_SHORT).show();
                break;
            case R.id.iv_record://播放历史
                Toast.makeText(context, "播放历史--尚未设计", Toast.LENGTH_SHORT).show();
                break;
        }
    }
}
